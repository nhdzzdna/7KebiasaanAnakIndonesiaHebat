...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        return Inertia::render('Admin/Profile/Index', [
            'user' => Auth::user(),
            'settings' => [
                'notifikasi_email' => Setting::getValue('notifikasi_email', '1') === '1',
                'laporan_otomatis' => Setting::getValue('laporan_otomatis', '0') === '1',
                'alert_pengguna_baru' => Setting::getValue('alert_pengguna_baru', '1') === '1',
            ],
        ]);
    }
    ...
    {
        $validated = $request->validate([
            'notifikasi_email' => 'required|boolean',
            'laporan_otomatis' => 'required|boolean',
            'alert_pengguna_baru' => 'required|boolean',
        ]);
    ...
    public function resetKegiatanData(Request $request)
    {
        ...
        \App\Models\Kegiatan::whereBetween('tanggal', [
    ...
    public function deactivateAllStudents(Request $request)
    {
        ...
        \App\Models\User::where('role', 'siswa')->update([
